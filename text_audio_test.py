...
txt_noise = 'airport_0dB'
aud_noise = txt_noise
# aud_noise = 'clean'

scaler_name = '/home/amrgaballah/Desktop/model/c_ab_scaler.pkl'
model_name = '/home/amrgaballah/Desktop/model/clean_ab.h5'
...
print('Bal_Acc', nnn_metrics['Bal_Acc'])
print('Classification Report', nnn_metrics['Classification Report'])
